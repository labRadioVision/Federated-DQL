...
parser.add_argument('-epsilon', default=0.5, help="set epsilon-greedy parameter, use 1 for to start without initialization, use 0.5 for MAML initialization", type=float)
...
parser.add_argument('-task', default=1, help="task number", type=int)
...
parser.add_argument('-input_data', default='dataset_trajectories/data_robots1.mat', help="sets the path to the federated dataset, to compute new observations and rewards for input actions ", type=str)
...
parser.add_argument('-input_rewards', default='dataset_trajectories/rewards1.mat', help="sets the path to the input rewards per robot position", type=str)
...
max_memory_length = 10000 # previous 100000
...
def processData(device_index, number_positions_devices, federated, target_server, initialization, update_after_actions):
    ...
    checkpointpath1_back = 'model_dql_dump/meta105/model{}.h5'.format(0)
    checkpointpath2_back = 'model_dql_dump/meta105/model_target{}.h5'.format(0)
    outfile_models_back = 'model_dql_dump/meta105/dump_train_model{}.npy'.format(0)
    ...
    n_file_cfa = "models_saved/CFA_robot_{}_number_{}_neighbors_{}_explored_pos_{}_update_{}_run_{}_task_{}_init_{}.mat".format(device_index,
                                                                                                   devices,
                                                                                                   args.N,
                                                                                                   number_positions_devices,
                                                                                                   update_consensus,
                                                                                                   args.run, args.task, args.initialization)
    n_file_cfa_h5 = "models_saved/CFA_robot_{}_number_{}_neighbors_{}_explored_pos_{}_update_{}_run_{}_task_{}_init_{}.h5".format(device_index,
                                                                                                   devices,
                                                                                                   args.N,
                                                                                                   number_positions_devices,
                                                                                                   update_consensus,
                                                                                                   args.run, args.task, args.initialization)
    n_file_fa = "models_saved/FA_robot_{}_number_{}_explored_pos_{}_update_{}_run_{}_task_{}_init_{}.mat".format(device_index, devices,
                                                                                                 number_positions_devices,
                                                                                                 update_consensus,
                                                                                                 args.run, args.task, args.initialization)
    n_file_fa_h5 = "models_saved/FA_robot_{}_number_{}_explored_pos_{}_update_{}_run_{}_task_{}_init_{}.h5".format(device_index, devices,
                                                                                                 number_positions_devices,
                                                                                                 update_consensus,
                                                                                                 args.run, args.task, args.initialization)
    n_file_cl = "models_saved/CL_datacenter_{}_number_{}_explored_pos_{}_update_{}_run{}_task_{}_init_{}.mat".format(device_index, devices,
                                                                                              number_positions_devices,
                                                                                              update_after_actions,
                                                                                              args.run, args.task, args.initialization)
    n_file_cl_h5 = "models_saved/CL_datacenter_{}_number_{}_explored_pos_{}_update_{}_run{}_task_{}_init_{}.h5".format(device_index, devices,
                                                                                              number_positions_devices,
                                                                                              update_after_actions,
                                                                                              args.run, args.task, args.initialization)
    n_file_isolated = "models_saved/Isolated_robot_{}_number_{}_explored_pos_{}_update_{}_run_{}_task_{}_init_{}.mat".format(
        device_index, devices,
        number_positions_devices,
        update_after_actions,
        args.run, args.task, args.initialization)

    n_file_isolated_h5 = "models_saved/Isolated_robot_{}_number_{}_explored_pos_{}_update_{}_run_{}_task_{}_init_{}.h5".format(
        device_index, devices,
        number_positions_devices,
        update_after_actions,
        args.run, args.task, args.initialization)
    ...
    if os.path.isfile(checkpointpath1_back) and args.initialization == 1:
        train_start = True
...
if __name__ == "__main__":
    ...
    if args.initialization == 1 or args.initialization == 0: # clear all files
        # DELETE TEMPORARY CACHE FILES
