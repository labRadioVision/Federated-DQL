...
parser.add_argument('-episodes', default=15, help="number of episodes per task", type=int)
parser.add_argument('-centralized', default=1, help="centralized RL", type=int)
parser.add_argument('-update_federation', default=10, help="counts the number of frames (robot movements) per epoch", type=int)
...
parser.add_argument('-input_rewards', default='dataset_trajectories/rewards1.mat', help="sets the path to the tasks, namely the input rewards for each defined task", type=str)
...
update_target_network = 500 # other option 500
